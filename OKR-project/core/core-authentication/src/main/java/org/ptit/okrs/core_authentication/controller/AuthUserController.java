...
public class AuthUserController {
  ...
  public void activeAccount(@Valid @RequestBody AuthUserActiveAccountRequest request, AuthAccount authAccount) {
    log.info("(activeAccount)request: {}", request);
    authFacadeService.activeAccount(request, authAccount);
  }
