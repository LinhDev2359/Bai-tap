  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    return http.cors(Customizer.withDefaults())
        ...
        .authorizeHttpRequests(authorize -> authorize
            ...
            .requestMatchers("/api/v1/user-profiles/**", "/api/v1/posts/**", "/api/v1/account/change-password").hasRole("USER")
            .requestMatchers("/api/v1/user-profiles/{id}", "/api/v1/posts/**", "/api/v1/account/change-password").hasRole("CUSTOMER")
